...
#### 🎨 UI/UX 改进
- **标题文案更新**: 将主标题从 "Turn text into comic mind-maps in seconds" 改为 "Transfer your idea into interesting comic mind-maps"
- **分层排版设计**: 采用三层结构展示标题，增强视觉层次感
  - 第一层: "Transfer your idea" (带有主色调背景高亮)
  - 第二层: "into interesting" (使用辅助色突出显示)  
  - 第三层: "comic mind-maps" (渐变色文字效果)
- **配色优化**: 
  - "idea" 使用主色调 + 半透明背景
  - "interesting" 使用辅助色 + 加粗字体
  - "comic mind-maps" 使用渐变色背景裁剪文字效果

#### 🔧 技术实现
- 优化 `HeroSection.tsx` 组件的标题结构
- 使用 Tailwind CSS 的 `bg-clip-text` 实现渐变文字效果
- 响应式字体大小和间距调整
